...
# Synthetic Milestones Fixture (post-m2.13 ship)

Variant of milestones_synthetic.md where 3.7 has flipped from 🟡 NEXT
to ✅ SHIPPED with a fake commit SHA. Used by the
"end-to-end-with-modification" test that exercises the manual
sanity-check path: change milestones.md, re-run propagation, observe
mirror docs updated.
...
| 3.7 | ✅ SHIPPED 2026-04-26 at `deadbef`. m2.13 invest-screen MVP shipped. | m2.13 promoted from Bundle 4b. |
